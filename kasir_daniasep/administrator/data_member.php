				      		...
				      		<form action="proses_update_member.php" method="post">
					      		<div class="modal-body">
				        			...
				        			<div class="form-group">
				        				...
				        				<input type="text" name="jeniskelamin" class="form-control" value="<?php echo $d['jeniskelamin']; ?>">
				        			</div>
				        			<div class="form-group">
				        				<label>Alamat</label>
				        			...
				        			<div class="form-group">
				        				...
				        				<input type="number" name="notelepon" class="form-control" value="<?php echo $d['notelepon']; ?>">
				        			</div>
					        	</div>
      		...
      		<form action="proses_simpan_member.php" method="post">
      			<div class="modal-body">
        			...
        			<div class="form-group">
        				...
        				<input type="text" name="jeniskelamin" class="form-control" autocomplete="off">
        			</div>       			
        			<div class="form-group">
        				<label>Alamat </label>
        			...
        			<div class="form-group">
        				<label>No.Telepon </label>
        				<input type="text" name="notelepon" class="form-control" autocomplete="off">
        			</div>
        		</div>
        		<div class="modal-footer">
